    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Manajemen Transaksi</h2>
            <p className="text-gray-600 dark:text-gray-400">Kelola transaksi dan pembayaran</p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-green-800 dark:text-green-300">Total Pendapatan</span>
          </div>
        ...
        <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-yellow-800 dark:text-yellow-300">Jumlah Tertunda</span>
          </div>
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-blue-800 dark:text-blue-300">Total Transaksi</span>
          </div>
          <p className="text-2xl font-bold text-blue-900 dark:text-blue-200">{transactions.length}</p>
        </div>
        <div className="p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
          <div className="flex items-center space-x-2 mb-2">
            <CheckCircle className="w-5 h-5 text-purple-600 dark:text-purple-400" />
            <span className="text-sm font-medium text-purple-800 dark:text-purple-300">Tingkat Keberhasilan</span>
          </div>
      ...
      <div className="flex space-x-1 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg">
        {[
          ...
          { id: 'pending', label: 'Tertunda', count: transactions.filter(t => t.status === 'pending').length },
          { id: 'completed', label: 'Selesai', count: transactions.filter(t => t.status === 'completed').length },
          ...
          >
            <span>{label}</span>
            <span className="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-400 rounded-full text-xs">
              {count}
            </span>
          </button>
        ))}
      ...
      <div className="chart-container">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Transaksi Terkini</h3>
        <div className="space-y-3">
          {filteredTransactions.map((transaction) => (
            <div
              key={transaction.id}
              className="p-4 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-lg hover:shadow-md transition-shadow"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">{transaction.customerName}</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">{transaction.customerEmail}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-500">Pesanan: {transaction.orderId}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors"
                  >
                    Lihat Detail
                  </button>
                </div>
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Barang:</p>
      ...
      {/* Payment Methods */}
      <div className="chart-container">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Metode Pembayaran Tersedia</h3>
